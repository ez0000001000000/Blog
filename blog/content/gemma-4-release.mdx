...
> **Asset Note:** The thumbnail for this post was retrieved using the following command:
> `curl -L -o public/gemma-4.png https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?auto=format&fit=crop&q=80&w=1600`
